...
//NoiseInput getNoiseInputArrays(ResourceNoiseGenerationRequest resourceNoiseGenerationRequest) {
//
//    int minTileX = resourceNoiseGenerationRequest.getRegionX() * 4;
//    int minTileY = resourceNoiseGenerationRequest.getRegionY() * 4;
//
//    int totalHeight = resourceNoiseGenerationRequest.getMaxHeight() - resourceNoiseGenerationRequest.getMinHeight();
//
//    float* regionArrayX[X_ARRAY_SIZE];
//    float* regionArrayY[Y_ARRAY_SIZE];
//    float* regionArrayZ = new float[totalHeight];
//
//
